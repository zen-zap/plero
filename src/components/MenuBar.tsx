        ...
        {MENU_STRUCTURE.map((menu) => (
          ...
          >
            ...
            {activeMenu === menu.label && (
              <div className="absolute mt-1 left-0 bg-prussian-blue border border-dusk-blue shadow-xl py-1 z-50 min-w-[200px] rounded">
                {menu.items.map((item, idx) =>
                  item.type === "separator" ? (
                    <div
                      key={idx}
                      className="h-px bg-dusk-blue my-1 mx-2 opacity-50"
                    />
                  ) : (
                    <div
                      key={idx}
                    ...
                    >
                      ...
                      {item.shortcut && (
                        <span className="text-lavender-grey/50 text-xs">
                          {item.shortcut}
                        </span>
                      )}
                    </div>
